...
async def generate_response(
    ...
    description from MongoDB, and passes all these as inputs to the runnable to generate a response.
    ...
    Args:
        ...
        username (str): The username of the user (assumed to be user_id).
    ...
    try:
        ...
        personality_description = user_profile.get("userData", {}).get("personality", "None")
