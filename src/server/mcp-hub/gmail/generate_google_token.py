...
CREDENTIALS_FILE = "server/mcp-hub/gmail/credentials.json"
ENV_FILE = "server/.env"
...
async def main():
    ...
    # Prompt the user for a unique ID. This will be the document _id in MongoDB.
    ...
    # This format is exactly what auth.get_google_creds expects.
    ...
    try:
        ...
        # Use update_one with upsert=True to create or update the user profile
